...
import RegisterSecondPage from './RegisterSecondPageCause'
import RegisterThirdPage from './RegisterThirdPageCause'
  ...
  render () {
    ...
    return (
      <div>
        ...
        {page === 2 && <RegisterThirdPage onNext={this.nextPage} entityType={entityType} />}
        {page === 3 && <RegisterAddress entityType={entityType} />}
      </div>
    )
  }
}
